...
def task2():
    global t
    original_photo = cv2.imread(img[0], cv2.IMREAD_GRAYSCALE)
...
while True:
    ...
    if key == ord(' ') or key == 27:  # Spacebar or Esc key
        cv2.imwrite(f'output/depth.png', disparityNormalised)
        break
